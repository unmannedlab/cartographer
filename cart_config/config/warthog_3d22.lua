...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 4e2
...
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 1000--200
POSE_GRAPH.optimization_problem.huber_scale = 5e2
POSE_GRAPH.optimize_every_n_nodes = 200
POSE_GRAPH.global_sampling_ratio = 0.003
POSE_GRAPH.constraint_builder.min_score = 0.50
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.55
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_xy_search_window = 40.
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.full_resolution_depth = 5
...
POSE_GRAPH.constraint_builder.loop_closure_translation_weight=4e5
