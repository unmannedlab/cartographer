...
#ifndef CARTOGRAPHER_ROS_CARTOGRAPHER_ROS_OUTPUT_POSE_H
#define CARTOGRAPHER_ROS_CARTOGRAPHER_ROS_OUTPUT_POSE_H

namespace cartographer_ros {

class OutputPose {
 public:
  OutputPose(const std::string& pose_graph_filename,
